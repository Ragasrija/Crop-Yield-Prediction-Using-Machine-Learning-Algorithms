...
main = tkinter.Tk()
main.title("Crop Yield Prediction using Machine Learning and python")
...
font = ('times', 15, 'bold')
title = Label(main, text='Crop Yield Prediction using Machine Learning and python', justify=LEFT)
